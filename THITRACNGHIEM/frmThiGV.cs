...
{
    public partial class frmThiGV : DevExpress.XtraEditors.XtraForm
    {
        ...
        int soCauHoi = 0;
        public frmThiGV(string maMH, string tenMH, string maGV, string tenGV, string maLop, string tenLop, int lan, int soCauThi, int thoiGian)
        {
            InitializeComponent();
            ...
            string strLenh = "EXEC SP_LAYDETHITHUGV '" + maLop + "', '" + maMH + "'," + lan;
